...
## Project Structure
    ...
    ├── emotional_self_defe_30248  # Django project configurations
...
1. Clone this repo and `cd emotional_self_defe_30248`
...
2. Clone this repo and `cd emotional_self_defe_30248`
